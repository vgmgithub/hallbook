    ...
    const columns = useMemo(
      () => [
        ...
        },
        {
          ...
          Cell: ({ row }) => (
            <>
             <Link to={`/venue/edit/${row.original._id}`}> <FontAwesomeIcon icon={faPencil}/></Link> &nbsp;
             <FontAwesomeIcon icon={faTrash} onClick={() => confirm(row)}/>
            </>
          ),
        },
      ],
